...
/******/ 	var hotCurrentHash = "8448a32ede3fab3bdc23"; // eslint-disable-line no-unused-vars
	...
	*/
	...
	$(document).ready(function () {
	    ...
	    $('.cart').on('click', '.select-product__close', function () {
	        ...
	        if (items.length == 1) {
	            $('.cart').addClass('hide');
	            $('.cart-empty').addClass('show').removeClass('hide');
	        }
	    });
	    ...
	    $('.index-tabs__list').on('click', '.index-tabs__item', function () {
	        ...
	        content.removeClass('hide').addClass('show').siblings('.index-tabs__content-item').removeClass('show').addClass('hide');
